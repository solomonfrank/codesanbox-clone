...
export const Hero = () => {
  ...
  useEffect(() => {
    const updateMousePosition = (ev: MouseEvent) => {
      ...
      console.log("pos=>", clientX, clientY);
  ...
  return (
    <motion.section
      ref={targetRef}
      style={{ opacity }}
      className="relative mb-[8rem] h-screen py-16 text-white before:fixed before:inset-0 before:opacity-40  before:z-0 before:bg-[radial-gradient(circle_farthest-side_at_var(--x,_100px)_var(--y,_100px),_var(--color-secondary)_0%,_transparent_100%)]"
    >
      <motion.div
