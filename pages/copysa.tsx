...
const CodeSanbox = () => {
  ...
  const squareScale = useTransform(
    scrollYProgress,
    [0, 0.1, 0.13, 0.15, 0.16, 0.17, 0.18, 0.19, 0.2, 0.35, 0.39, 0.45, 0.71],
    [2.5, 2.2, 2.1, 2, 1.85, 1.8, 1.75, 1.6, 1.5, 1.0, 0.98, 0.98, 0]
  );
  ...
  const squareOpacity12 = useTransform(
    scrollYProgress,
    [0, 0.37, 0.39, 0.7, 0.71, 0.8],
    [1, 1, 1, 0, 0, 0]
  );

  const squareOpacity13 = useTransform(
    scrollYProgress,
    [0, 0.43, 0.45, 0.47, 0.7],
    [0, 1, 1, 1, 0]
  );
  ...
  const scale2Opacity = useTransform(
    scrollYProgress,
    [0, 0.4, 0.42, 0.43, 0.45, 0.47, 0.7, 0.8],

    [0, 0.45, 0.5, 0.45, 0.8, 1, 0, 0]
  );
